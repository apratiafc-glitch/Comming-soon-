  ...
  if (count === 0) {
    _db.run(`
      ...
      (5, 'Area Sales Manager', 'Sales Leadership', 'Phnom Penh / Provinces, Cambodia', 'Full-time',
       ...
       '2026-09-30', 1, datetime('now')),
      (6, 'Modern Trade Sales Manager', 'Modern Trade', 'Phnom Penh, Cambodia', 'Full-time',
